  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className="absolute -top-2 -left-2 z-10 flex h-5 w-5 items-center justify-center rounded-full bg-white text-gray-500 shadow-md border border-gray-200 hover:text-obsidian hover:bg-gray-50 transition-colors"

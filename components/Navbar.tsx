...
const Navbar: React.FC = () => {
  ...
  return (
    <nav role="navigation" aria-label="Menú Principal" className="fixed w-full animate-fade-in z-50 bg-white/95 backdrop-blur-md shadow-sm border-b border-gray-100 py-2.5">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-50">
        <div className="flex justify-between items-center">
          ...
          {/* Desktop Menu */}
          <div role="navigation" aria-label="Menú Principal" className="hidden md:flex items-center space-x-12">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
          ...
          <div className="md:hidden">
            <button
              onClick={() => setIsOpen(!isOpen)} aria-label="Abrir Menú" aria-expanded={isOpen}
